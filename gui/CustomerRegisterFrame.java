...
public class CustomerRegisterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 42)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Registration");

        jLabel2.setIcon(new javax.swing.ImageIcon("D:\\Yum Express assets\\icons\\icons\\login.png")); // NOI18N
    ...
    private void btnRegisterCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterCustomerActionPerformed
        ...
        try{
            ...
            if(result){
                ...
                emailCredentials.put("emailId",""); 
                emailCredentials.put("securityKey","");
   ...
   private void clearAll() {
    ...
    public boolean validateInputs(){
        ...
        if(MyValidator.isValidEmail(this.txtEmail.getText().trim())==false){
